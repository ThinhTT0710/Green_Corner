...
namespace GreenCorner.MVC.Services
{
    public class VolunteerService:IVolunteerService
    {
        ...
        public async Task<ResponseDTO?> GetVolunteerDetailsAsync(int eventId, string userId)
        {
            return await _baseService.SendAsync(new RequestDTO
            {
                APIType = SD.APIType.GET,
                Url = $"{SD.EventAPIBase}/api/Volunteer/details-by-user?eventId={eventId}&userId={userId}"
            });
        }
        ...
        public async Task<ResponseDTO?> GetAllVolunteersForEvent(int eventId)
        {
            return await _baseService.SendAsync(new RequestDTO
            {
                APIType = SD.APIType.GET,
                Url = $"{SD.EventAPIBase}/api/Volunteer/get-event-volunteer/{eventId}"
            });
        }
    }
}
