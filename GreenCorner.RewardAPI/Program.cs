...
using GreenCorner.RewardAPI.Extensions;
using GreenCorner.RewardAPI.Mapping;
...
builder.Services.AddScoped<IRewardRedemptionHistoryRepository, RewardRedemptionHistoryRepository>();
